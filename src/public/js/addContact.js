  ...
  $(".user-add-new-contact").bind("click", function() {
    ...
    $.post("/contact/add-new", {uid: targetId}, function(data) {
      if (data.success) {
        ...
        increaseNumberNotiContact("count-request-contact-sent"); //js/caculateNotifContact.js

        // Add at modal tad "Đang chờ xác nhận"
...
socket.on("response-add-new-contact", function(user) {
  ...
  //Add notification at modal on "Yêu cầu kết bạn" tab
